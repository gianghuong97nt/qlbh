                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="{{route('admin.shop.product')}}"><i class="fa fa-angle-right"></i> Danh sách sản phẩm</a></li>
                        </ul>
                    </li>
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            <li><a href="admin/shop/oder"><i class="fa fa-angle-right"></i> Danh sách đơn hàng</a></li>
                        </ul>
                    </li>
                    <li class="treeview">
                        <a>
                        ...
                        <ul class="treeview-menu">
                            <li><a href="#"><i class="fa fa-angle-right"></i> Danh sách người dùng</a></li>
                        </ul>
                    </li>
